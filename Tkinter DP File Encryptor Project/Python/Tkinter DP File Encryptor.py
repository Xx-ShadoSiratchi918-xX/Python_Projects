...
select_file_image = PhotoImage(file="../IMG/carpeta-de-archivos-azul-con-los-documentos-34337927 (1).png")
...
example_image = PhotoImage(file="../IMG/2023-05-05 10_06_48-Encriptador dArxius DP.png")
alternative_example = Label(page5, image=example_image)
example2_image = PhotoImage(file="../IMG/2023-05-05 10_05_01-Python_Projects.py – Tkinter DP File Encryptor.py.png")
